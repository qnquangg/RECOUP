...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>unicast-receiver-2</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/multicast/simulations-bmrf/unicast-receiver.c</source>
      <commands EXPORT="discard">make unicast-receiver.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/multicast/simulations-bmrf/unicast-receiver.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>125.16627624605837</x>
        <y>93.29359900765165</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.035837363390495 0.0 0.0 2.035837363390495 14.090909090909102 39.53470268752619</viewport>
    </plugin_config>
    <width>322</width>
    <z>2</z>
    <height>349</height>
...
- 19 Sinks, listening to multicast packets from root.
- Grid topo.
- Unicast protocol</notes>
