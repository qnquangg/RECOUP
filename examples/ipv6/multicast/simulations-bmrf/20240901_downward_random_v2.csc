...
<simconf>
  ...
  <simulation>
    <title>simulation-bmrf-v1</title>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/multicast/simulations-bmrf/internal-seed.c</source>
      <commands EXPORT="discard">make internal-seed.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/multicast/simulations-bmrf/internal-seed.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>1.6346845433860935</x>
        <y>-0.12469781068678287</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>54.34489247242831</x>
        <y>-72.6009926033178</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>28.911219215174327</x>
        <y>52.05854867174716</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-18.457627143055745</x>
        <y>33.04278586501924</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.53893433004562</x>
        <y>-45.4196047106306</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-23.28848088745042</x>
        <y>-69.24445769068612</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-35.361065454952076</x>
        <y>-99.13056706815766</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>42.71929548297331</x>
        <y>37.8694637515442</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>24.37428539653581</x>
        <y>29.494317499204698</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-33.63811860958461</x>
        <y>95.08517853139813</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-50.183497075706676</x>
        <y>75.47178906192612</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-87.85578187987429</x>
        <y>7.799193922851046</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>24.408383866355113</x>
        <y>-25.35113888062189</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>45.98954837538929</x>
        <y>63.23273876225349</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-37.43022638839772</x>
        <y>-1.677275668351852</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-66.76528356679788</x>
        <y>25.324811409546882</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-23.150740758457914</x>
        <y>70.77926521013464</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-16.572787473501123</x>
        <y>90.58072934110433</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>60.08830508179261</x>
        <y>-16.687341895385277</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>86.71690334133214</x>
        <y>-90.0419264148127</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-12.46331665584124</x>
        <y>-34.76733149778487</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.0059973324353852 0.0 0.0 1.0059973324353852 152.00981176432603 131.3567694304765</viewport>
    </plugin_config>
    <width>322</width>
    <z>4</z>
    <height>349</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>Downward testing:
- 1 Root, sending 1000 packets, 3 seconds interval.
- 20 Sinks, listening to multicast packets from root.
- Random topo.
- Multicast protocols: ROLL-TM, SMRF, ESMRF, BMRF (unicast, mixed, broadcast).
- MAC: CSMA, NULLMAC
- RDC: CONTIKIMAC, CXMAC, NULLRDC


Setup:
0. In simulation script editor, change protocol:
prototol_file_name = "rolltm";
prototol_file_name = "smrf";
prototol_file_name = "esmrf";
prototol_file_name = "bmrf-unicast";
prototol_file_name = "bmrf-broadcast";
prototol_file_name = "bmrf-mixed";
----------------------------
...
#define NETSTACK_CONF_MAC	nullmac_driver</notes>
...
&#xD;
&#xD;
simulation_time = 3500000;&#xD;
TIMEOUT(3500000, timeout_func()); /* milliseconds */&#xD;
&#xD;
total_sent = 1000;&#xD;
&#xD;
outs = new Array(1000);&#xD;
...
total_nodes = 0;&#xD;
&#xD;
fr = new File("results/"+ prototol_file_name + rdc + mac+ topo+"_raw_results.csv");&#xD;
fd = new File("results/"+ prototol_file_name + rdc + mac+ topo+"_delay_results.csv");&#xD;
fs = new File("results/"+ prototol_file_name + rdc + mac+ topo+"_summary_results.csv");&#xD;
...
timeout_func = function simulationEnd() {&#xD;
  ...
  log.log("Packet delivery ratio: " + (pdr/total_subscribed*100/total_sent) + "%\n");&#xD;
