...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>124.66952313776797</x>
        <y>95.10309581823948</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>1.5967741935483861</x>
        <y>-0.532258064516129</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.8787878787878785 0.0 0.0 1.8787878787878785 22.004060044893286 20.902373737373814</viewport>
    </plugin_config>
    <width>322</width>
    <z>4</z>
    <height>349</height>
...
&#xD;
&#xD;
simulation_time = 3450000;&#xD;
TIMEOUT(3450000, timeout_func()); /* milliseconds */&#xD;
&#xD;
total_sent = 1000;&#xD;
&#xD;
outs = new Array(1000);&#xD;
...
total_nodes = 0;&#xD;
&#xD;
fr = new File("results/"+ prototol_file_name + rdc + mac+ "_raw_results.csv");&#xD;
fd = new File("results/"+ prototol_file_name + rdc + mac+ "_delay_results.csv");&#xD;
fs = new File("results/"+ prototol_file_name + rdc + mac+ "_summary_results.csv");&#xD;
