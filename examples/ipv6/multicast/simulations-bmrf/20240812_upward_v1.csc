...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>49.196508172689036</x>
        <y>45.056409805419335</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>73.85740482287514</x>
        <y>72.05733158295394</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>17.285178053775432</x>
        <y>18.712655835763705</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>76.44165701388113</x>
        <y>19.15527173024751</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>85.38688410786152</x>
        <y>-16.036737549616205</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>145.89558579582888</x>
        <y>-5.485777455543052</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>31.2276987264708</x>
        <y>108.7765787418905</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-2.3742644029289828</x>
        <y>-8.492048483645368</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>109.35517682051133</x>
        <y>1.2866463705699331</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>27.103018965790483</x>
        <y>69.43584131398276</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>54.249368272667496</x>
        <y>71.66403602256709</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.583926095114193 0.0 0.0 1.583926095114193 47.3364169202575 78.5534727394053</viewport>
    </plugin_config>
    <width>322</width>
    <z>4</z>
    <height>349</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>Upward.
- Internal seed (sink) sends 100 packets.
...
- 10 intermediates
- 10 sinks
- 1 internal seed (send 100 packets)

Notes:
- Root will not receive any multicast packets.
- Check: how much nodes are subcribed in multicast topo</notes>
...
timeout_func = function simulationEnd() {&#xD;
  ...
  log.log("Total subscription: " + total_subscribed + "\n");&#xD;
