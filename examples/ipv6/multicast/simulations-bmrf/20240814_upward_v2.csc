...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-15.467182386695427</x>
        <y>-41.43539635466836</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-30.146866454448748</x>
        <y>-66.10730673163658</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-61.4012914503977</x>
        <y>-12.605694180288538</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.150704067762051 0.0 0.0 1.150704067762051 146.90775608349364 173.81195585579692</viewport>
    </plugin_config>
    <width>322</width>
    <z>4</z>
    <height>349</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>Upward testing:
- 1 Root, doing nothing.
- 1 Seed, sending 100 packets.
- 19 Sinks, listening to multicast packets.
- Random topo.
- Multicast protocols: ROLL-TM, SMRF, ESMRF, BMRF (unicast, mixed, broadcast).

Results:
Saved in folder: 
/home/user/contiki/tools/cooja/build/results
...
#define BMRF_CONF_BROADCAST_THRESHOLD   2</notes>
...
TIMEOUT(500000, timeout_func()); /* milliseconds */&#xD;
&#xD;
outs = new Array(100);&#xD;
total_time = 0;&#xD;
total_ins = 0;&#xD;
...
total_nodes = 0;&#xD;
&#xD;
fr = new File("results/"+ prototol_file_name + "_raw_results_upward.csv");&#xD;
fd = new File("results/"+ prototol_file_name + "_delay_results_upward.csv");&#xD;
fs = new File("results/"+ prototol_file_name + "_summary_results_upward.csv");&#xD;
